...
import resume from '../../../Assets/Resume/Raymond_Chau_Resume.pdf';
  ...
  render() {
    ...
    return (
      <Container>
        ...
        <SocialMediaIcons>
          <SocialLogo imgURL={mailImg} alternate="Mail" redirectURL="mailto:ray.chau@berkeley.edu" />
          <SocialLogo imgURL={linkedInImg} alternate="Linkedin" redirectURL="https://www.linkedin.com/in/raymond-chau" />
          <SocialLogo imgURL={githubImg} alternate="Github" redirectURL="https://github.com/delcharay" />
          <SocialLogo imgURL={resumeImg} alternate="Resume" redirectURL={resume} />
        </SocialMediaIcons>
      </Container>
    );
  }
